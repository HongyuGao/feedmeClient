  ...
  methods.init = function(options) {
    ...
    return this.each(function() {
      ...
      if (!data) {
        ...
        obj.addClass('dd-container').append(ddSelectHtml).append(
          ddOptionsHtml);
        ...
        $.each(options.data, function(index, item) {
          ...
          ddOptions.append('<li>' +
            ...
            (item.imageSrc ? ' <img class="dd-option-image' + (
              ...
              '" />' : '') +
            (item.text ? ' <label class="dd-option-text">' + item
              .text + '</label>' : '') +
            (item.description ?
        ...
        if (options.selectText.length > 0 && options.defaultSelectedIndex ==
          ...
          var index = (options.defaultSelectedIndex != null && options.defaultSelectedIndex >=
              0 && options.defaultSelectedIndex < options.data.length) ?
        ...
        if (options.clickOffToClose) {
          ...
          $('body').on('click', function() {
            $('.dd-click-off-close').slideUp(50).siblings(
              '.dd-select').find('.dd-pointer').removeClass(
              'dd-pointer-up');
          });
        }
      }
    ...
    if (settings.showSelectedHTML) {
      ddSelected.html(
        ...
        (selectedData.description ?
          '<small class="dd-selected-description dd-desc' + (settings.truncateDescription ?
